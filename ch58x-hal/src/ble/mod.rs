...
use self::ffi::{BLE_PAControlInit, SYS_EVENT_MSG, tmos_event_hdr_t, tmos_msg_deallocate, tmos_msg_receive};
use crate::ble::ffi::{BLE_RegInit, blePaControlConfig_t, tmos_start_task};
...
pub fn init(
    ...
    use ffi::{BLE_LibInit, LL_TX_POWEER_6_DBM, TMOS_ProcessEventRegister, TMOS_TimerInit, bleConfig_t};
